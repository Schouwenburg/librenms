...
class Iosxe extends Ciscowlc implements WirelessRssiDiscovery, WirelessSnrDiscovery, WirelessRsrqDiscovery, WirelessRsrpDiscovery, WirelessSinrDiscovery, WirelessCellbandDiscovery, WirelessCellidDiscovery
{
    use CiscoCellular;
}
